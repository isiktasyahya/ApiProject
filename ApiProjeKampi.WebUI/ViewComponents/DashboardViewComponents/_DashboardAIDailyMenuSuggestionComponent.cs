...
{
    public class _DashboardAIDailyMenuSuggestionComponent : ViewComponent
    {
        private const string OPENAI_API_KEY = "";

        private readonly IHttpClientFactory _httpClientFactory;

        public _DashboardAIDailyMenuSuggestionComponent(IHttpClientFactory httpClientFactory)
        {
