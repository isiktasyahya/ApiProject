...
namespace ApiProjeKampi.WebUI.ViewComponents.AdminLayoutNavbarViewComponent
{
    public class _NavbarNotificationAdminLayoutComponentPartial:ViewComponent
    {
        ...
        public async Task<IViewComponentResult> InvokeAsync()
        {
            ...
            var responseMessage = await client.GetAsync("https://localhost:7063/api/Notifications/");
